...
Version  : 1.4.5
Release  : 7
URL      : https://github.com/VcDevel/Vc/archive/1.4.5/Vc-1.4.5.tar.gz
Source0  : https://github.com/VcDevel/Vc/archive/1.4.5/Vc-1.4.5.tar.gz
...
%prep
%setup -q -n Vc-1.4.5
cd %{_builddir}/Vc-1.4.5
pushd ..
cp -a Vc-1.4.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719950382
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/Vc-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/Vc/6c8c6d9c0fc3041e685edf9266d924ffd2e5002d || :
export GOAMD64=v2
pushd ../buildavx2/
GOAMD64=v3
pushd clr-build-avx2
